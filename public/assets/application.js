...
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/activities/activity"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<td>', title ,'</td>\n<td>', comment ,'</td>\n<td>', estimate ,'</td>\n<td>', day_list_id ,'</td>\n\n<td><a href="#/', id ,'">Show</td>\n<td><a href="#/', id ,'/edit">Edit</td>\n<td><a href="#/', id ,'/destroy" class="destroy">Destroy</a></td>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/activities/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Edit activity</h1>\n\n<form id="edit-activity" name="activity">\n  <div class="field">\n    <label for="title"> title:</label>\n    <input type="text" name="title" id="title" value=', title ,' >\n  </div>\n\n  <div class="field">\n    <label for="comment"> comment:</label>\n    <input type="text" name="comment" id="comment" value=', comment ,' >\n  </div>\n\n  <div class="field">\n    <label for="estimate"> estimate:</label>\n    <input type="text" name="estimate" id="estimate" value=', estimate ,' >\n  </div>\n\n  <div class="field">\n    <label for="day_list_id"> day_list_id:</label>\n    <input type="text" name="day_list_id" id="day_list_id" value=', day_list_id ,' >\n  </div>\n\n  <div class="actions">\n    <input type="submit" value="Update Activity" />\n  </div>\n\n</form>\n\n<a href="#/index">Back</a>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/activities/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Listing activities</h1>\n\n<table id="activities-table">\n  <tr>\n    <th>Title</th>\n    <th>Comment</th>\n    <th>Estimate</th>\n    <th>Day list</th>\n    <th></th>\n    <th></th>\n    <th></th>\n  </tr>\n</table>\n\n<br/>\n\n<a href="#/new">New Activity</a>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/activities/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>New activity</h1>\n\n<form id="new-activity" name="activity">\n  <div class="field">\n    <label for="title"> title:</label>\n    <input type="text" name="title" id="title" value=', title ,' >\n  </div>\n\n  <div class="field">\n    <label for="comment"> comment:</label>\n    <input type="text" name="comment" id="comment" value=', comment ,' >\n  </div>\n\n  <div class="field">\n    <label for="estimate"> estimate:</label>\n    <input type="text" name="estimate" id="estimate" value=', estimate ,' >\n  </div>\n\n  <div class="field">\n    <label for="day_list_id"> day_list_id:</label>\n    <input type="text" name="day_list_id" id="day_list_id" value=', day_list_id ,' >\n  </div>\n\n  <div class="actions">\n    <input type="submit" value="Create Activity" />\n  </div>\n\n</form>\n\n<a href="#/index">Back</a>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["backbone/templates/activities/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p>\n  <b>Title:</b>\n  ', title ,'\n</p>\n\n<p>\n  <b>Comment:</b>\n  ', comment ,'\n</p>\n\n<p>\n  <b>Estimate:</b>\n  ', estimate ,'\n</p>\n\n<p>\n  <b>Day list:</b>\n  ', day_list_id ,'\n</p>\n\n\n<a href="#/index">Back</a>\n');}return __p.join('');};
}).call(this);
(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  Tigerella.Models.Activity = (function() {
  ...
  Tigerella.Collections.ActivitiesCollection = (function() {
    ...
    ActivitiesCollection.prototype.model = Tigerella.Models.Activity;
...
(function() {
  ...
  (_base = Tigerella.Views).Activities || (_base.Activities = {});

  Tigerella.Views.Activities.ActivityView = (function() {
...
(function() {
  ...
  Tigerella.Views.Activities.EditView = (function() {
...
(function() {
  ...
  Tigerella.Views.Activities.IndexView = (function() {
    ...
    IndexView.prototype.initialize = function() {
      return this.options.activities.bind('reset', this.addAll);
    };

    IndexView.prototype.addAll = function() {
      return this.options.activities.each(this.addOne);
    };

    IndexView.prototype.addOne = function(activity) {
      var view;
      view = new Tigerella.Views.Activities.ActivityView({
        model: activity
      });
...
(function() {
  ...
  Tigerella.Views.Activities.NewView = (function() {
...
(function() {
  ...
  Tigerella.Views.Activities.ShowView = (function() {
...
(function() {
  ...
  Tigerella.Routers.ActivitiesRouter = (function() {

    __extends(ActivitiesRouter, Backbone.Router);

    function ActivitiesRouter() {
      ActivitiesRouter.__super__.constructor.apply(this, arguments);
    }

    ActivitiesRouter.prototype.initialize = function(options) {
      this.activities = new Tigerella.Collections.ActivitiesCollection();
    ...
    ActivitiesRouter.prototype.newActivity = function() {
      this.view = new Tigerella.Views.Activities.NewView({
    ...
    ActivitiesRouter.prototype.index = function() {
      this.view = new Tigerella.Views.Activities.IndexView({
    ...
    ActivitiesRouter.prototype.show = function(id) {
      ...
      this.view = new Tigerella.Views.Activities.ShowView({
        model: activity
      });
      return $("#activities").html(this.view.render().el);
    };
    ...
    ActivitiesRouter.prototype.edit = function(id) {
      var activity;
      activity = this.activities.get(id);
      this.view = new Tigerella.Views.Activities.EditView({
        model: activity
      });
      return $("#activities").html(this.view.render().el);
    };
